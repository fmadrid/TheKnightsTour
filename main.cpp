...
typedef std::array<std::array<unsigned int, BOARD_SIZE>, BOARD_SIZE> ChessBoard;
...
int main() {
	...
	do {
		...
		do {move = promptMove();}
		while (!isValidMove(board, move, pos));
...
////////////////////////////////////////////////////////////////////////////////////////////////
bool isValidMove(const ChessBoard& board, const MoveType& m, const Position& p) {
